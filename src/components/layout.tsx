...
export default function Layout({children}: Props) {
  ...
  const pages = data.allFile.nodes.filter((item: any) => item.name !== 'inicio')
  pages.unshift({name: 'inicio'})
        ...
        >
          ...
          <List dense>
            {pages.map((node: any) => {
              ...
              const link = node.name === 'inicio' ? '' : node.name
              return (
          ...
          <Divider />
          <Typography paragraph className={classes.drawerText} variant="caption">
            Sitio generado con <a href="https://github.com/raffazizzi/gatsby-theme-ceteicean" target="_blank">Gatsby Theme Ceteicean</a>.
            Distribuido bajo licencia MIT. Los contenidos de este sitio se encuentran bajo
            licencia <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank">
